    ...
    public void onBindViewHolder(final VcloudViewHolder holder, final int position) {
        ...
        if(holder instanceof VideoDateTipHolder){
            ...
            for (int i = 0; i < 3; i++) {
                ...
                subHolder.iv_select_mark.setImageResource(dataAccessor.isSelected(holder.getAdapterPosition(), i) ? R.drawable.video_list_selected : R.drawable.video_list_unselected);

                Glide.with(activity).load(Uri.parse(videoItem.getUriString())).placeholder(R.drawable.video_thumb).into(subHolder.iv_display);
                ...
                subHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(dataAccessor.isSelected(line, column)){
                            ...
                            subHolder.iv_select_mark.setImageResource(dataAccessor.isSelected(line, column) ? R.drawable.video_list_selected : R.drawable.video_list_unselected);
