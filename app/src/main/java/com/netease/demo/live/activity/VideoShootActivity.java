...
//            releaseFuEffect();
    ...
    public void onStartRecording() {
        ...
        getHandler().postDelayed(stopRecodingRunnable, videoCaptureParams.getTime() );
    }
...
//                        }
                        mode.setText(temp+"s");
                        Log.e(TAG,"时间: "+temp );
                        Log.e(TAG,"时间2: "+String.valueOf(temp) );
        ...
        if(timer != null && timerTask != null )timer.schedule(timerTask, 1, 100);
