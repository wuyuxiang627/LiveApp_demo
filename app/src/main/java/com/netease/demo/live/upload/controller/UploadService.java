...
import com.netease.demo.live.activity.MainActivity;
...
import com.netease.demo.live.upload.constant.TranscodeType;
...
//            showNotification("上传已完成", true);
    ...
    private void showNotification(String content, boolean autoCancel) {
        ...
        intent.putExtra(MainActivity.EXTRA_FROM_UPLOAD_NOTIFY, true);
